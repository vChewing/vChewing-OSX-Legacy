...
// MARK: - LXAssembly.OverrideSuggestion
...
extension LXAssembly {
  ...
  public final class LXPerceptor {
    ...
    let persistor: LXAssembly.PerceptionPersistor
    ...
    var testInjectedSuggestion: LXAssembly.OverrideSuggestion?
...
// MARK: - Internal Methods in LXAssembly.
...
extension LXAssembly.LXPerceptor {
  ...
  /// （引擎 alternatives 路徑、狂拼 OSNeutralAssembly 建議查詢）。
