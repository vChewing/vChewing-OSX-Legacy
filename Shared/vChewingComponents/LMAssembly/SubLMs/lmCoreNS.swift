  ...
  @frozen struct LMCoreNS {
    ...
    public func unigramsFor(key: String) -> [Megrez.Unigram] {
      ...
      for netaSet in arrRangeRecords {
        ...
        let halfValue = NSMutableString(string: theValue)
        CFStringTransform(halfValue, nil, kCFStringTransformFullwidthHalfwidth, false)
        if halfValue as String != theValue {
          gramsHW.append(Megrez.Unigram(value: halfValue as String, score: theScore))
        }
      }
