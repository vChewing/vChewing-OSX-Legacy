...
///
/// 註：此檔案為 vChewing-macOS 的 `vChewing_SettingsUI` Swift Package 內
/// 同名檔案的鏡像；legacy 倉庫無套件邊界，故直接編入 app target。
/// （legacy 為 Swift 5 語言模式、無預設 MainActor 隔離，故不標註 @MainActor。）
