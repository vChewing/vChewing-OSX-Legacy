  ...
  public func build() -> NSMenu {
    ...
    return NSMenu().appendItems {
      NSMenu.Item("i18n:Menu.vChewingSettings")?
        .act(register { CtlSettingsCocoa.show(); NSApp.popup() })
        .nulled(silentMode)
      ...
      )?.act(register { self.core?.toggleInputMode() })
      ...
      NSMenu.Item("i18n:UserDef.kUsingHotKeySCPC.shortTitle")?
        .act(register {
          ...
          Notifier
            .notify(
              message: "i18n:UserDef.kUsingHotKeySCPC.shortTitle"
                .i18n + "\n" +
                (
                  PrefMgr.shared.useSCPCTypingMode.toggled() ? "i18n:NotificationSwitch.On"
      ...
      NSMenu.Item("i18n:UserDef.kUsingHotKeyAssociates.shortTitle")?
        .act(register {
          ...
          Notifier
            .notify(
              message: "i18n:UserDef.kUsingHotKeyAssociates.shortTitle"
                .i18n + "\n" +
                (
                  PrefMgr.shared.associatedPhrasesEnabled.toggled() ? "i18n:NotificationSwitch.On"
                    .i18n : "i18n:NotificationSwitch.Off".i18n
                )
            )
        })
      ...
      NSMenu.Item("i18n:UserDef.kUsingHotKeyRevLookup.shortTitle")?
        .act(register {
          ...
          Notifier
            .notify(
              message: "i18n:UserDef.kUsingHotKeyRevLookup.shortTitle"
                .i18n + "\n" +
                (
                  PrefMgr.shared.cassetteEnabled.toggled() ? "i18n:NotificationSwitch.On"
                    .i18n : "i18n:NotificationSwitch.Off".i18n
                )
            )
      ...
      NSMenu.Item("i18n:UserDef.kFuriousTypingEnabled.shortTitle")?
        .act(register {
          ...
          Notifier
            .notify(
              message: "i18n:UserDef.kFuriousTypingEnabled.shortTitle"
                .i18n + "\n" +
                (
                  PrefMgr.shared.furiousTypingEnabled.toggled() ? "i18n:NotificationSwitch.On"
                    .i18n : "i18n:NotificationSwitch.Off".i18n
                )
            )
        })
      ...
      NSMenu.Item("i18n:UserDef.kUsingHotKeyCNS.shortTitle")?
        .act(register {
          ...
          Notifier
            .notify(
              message: "i18n:UserDef.kUsingHotKeyCNS.shortTitle"
                .i18n + "\n" +
                (
                  PrefMgr.shared.cns11643Enabled.toggled() ? "i18n:NotificationSwitch.On"
                    .i18n : "i18n:NotificationSwitch.Off".i18n
                )
            )
        })
      ...
      NSMenu.Item("i18n:UserDef.kUsingHotKeyKangXi.shortTitle")?
        .act(register {
          ...
          Notifier
            .notify(
              message: "i18n:UserDef.kUsingHotKeyKangXi.shortTitle"
                .i18n + "\n" +
                (
                  PrefMgr.shared.chineseConversionEnabled.toggled() ? "i18n:NotificationSwitch.On"
                    .i18n : "i18n:NotificationSwitch.Off".i18n
                )
            )
        })
      ...
      NSMenu.Item("i18n:UserDef.kUsingHotKeyHalfWidthASCII.shortTitle")?
        .act(register {
          ...
          Notifier
            .notify(
              message: "i18n:UserDef.kUsingHotKeyHalfWidthASCII.shortTitle"
                .i18n + "\n" +
                (
                  PrefMgr.shared.shiftJISShinjitaiOutputEnabled.toggled() ? "i18n:NotificationSwitch.On"
                    .i18n : "i18n:NotificationSwitch.Off".i18n
                )
            )
        })
      ...
      NSMenu.Item("i18n:UserDef.kUsingHotKeyCassette.shortTitle")?
        .act(register {
          ...
          Notifier
            .notify(
              message: "i18n:UserDef.kUsingHotKeyCassette.shortTitle"
                .i18n + "\n" +
                (
                  PrefMgr.shared.currencyNumeralsEnabled.toggled() ? "i18n:NotificationSwitch.On"
                    .i18n : "i18n:NotificationSwitch.Off".i18n
                )
            )
        })
      ...
      NSMenu.Item("i18n:UserDef.kUsingHotKeyCurrencyNumerals.shortTitle")?
        .act(register {
          ...
          Notifier
            .notify(
              message: "i18n:UserDef.kUsingHotKeyCurrencyNumerals.shortTitle"
                .i18n + "\n" +
                (
                  PrefMgr.shared.halfWidthPunctuationEnabled.toggled() ? "i18n:NotificationSwitch.On"
                    .i18n : "i18n:NotificationSwitch.Off".i18n
                )
            )
        })
      ...
      NSMenu.Item("i18n:UserDef.kPhraseReplacementEnabled.shortTitle")?
        .act(register {
          ...
          Notifier
            .notify(
              message: "i18n:UserDef.kPhraseReplacementEnabled.shortTitle"
                .i18n + "\n" +
                (
                  PrefMgr.shared.phraseReplacementEnabled.toggled() ? "i18n:NotificationSwitch.On"
                    .i18n : "i18n:NotificationSwitch.Off".i18n
                )
            )
        })
      ...
      NSMenu.Item("i18n:Menu.SymbolEmojiInput")?
        .act(register {
          ...
          Notifier
            .notify(
              message: "i18n:Menu.SymbolEmojiInput"
                .i18n + "\n" +
                (
                  PrefMgr.shared.symbolInputEnabled.toggled() ? "i18n:NotificationSwitch.On"
                    .i18n : "i18n:NotificationSwitch.Off".i18n
                )
            )
        })
      ...
      NSMenu.Item("i18n:Menu.RebootVChewing")?
        .act(register { NSApp.popup(); NSApp.terminate(nil) })
